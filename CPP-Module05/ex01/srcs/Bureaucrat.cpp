...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/30 04:04:27 by dmeirele          #+#    #+#             */
/*   Updated: 2024/08/02 12:47:37 by dmeirele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &form) const
{
	...
	{
		form.beSigned(*this);
		cout << Green <<this->name << " signed " << form << Reset;
	}
	catch(const std::exception& e)
	{
		std::cerr << Red << this->name << " couldn't sign " << form << "because " << e.what() << Reset <<'\n';
	}
}
